...
function MaintenancePanel({ title, copy }) {
  return (
  ...
  return (
    <main className={styles.page}>
      <DashboardShell
        ...
        topbar={<Topbar user={state.user} breadcrumbs={[{ label: "Workspace", href: "/dashboard" }, { label: "Inbox" }]} />}
      >
        <MaintenancePanel
          title="Inbox"
          copy="Inbox is currently under maintenance. You can open this page now, and we will build the full workspace here next."
        />
      </DashboardShell>
    </main>
  );
