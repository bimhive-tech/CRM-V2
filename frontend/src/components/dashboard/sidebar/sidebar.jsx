...
const navSections = [
  {
    ...
    items: [
      ...
      { id: "deals", label: "Projects", icon: <DealsIcon />, href: "/projects", match: ["/projects", "/deals"] },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "conversation", label: "Conversation", icon: <InboxIcon />, href: "/conversation", match: ["/conversation"] },
